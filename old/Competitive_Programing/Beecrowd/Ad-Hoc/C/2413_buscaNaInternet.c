...
#define mainMultiplier 2*2

int main(){
  int thirdLink;
  scanf("%d", &thirdLink);
  printf("%d\n", thirdLink * mainMultiplier);
  return 0;
}
...
/*
  ...
  João havia lido anteriormente, também na Internet, que o número de pessoas que clicam no segundo link listado é o dobro de número de pessoas
  que clicam no terceiro link listado. Nessa leitura, ele também descobriu que o número de pessoas que clicam no segundo link é a metade
